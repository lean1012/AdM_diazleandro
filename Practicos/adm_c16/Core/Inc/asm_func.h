...
void asm_eco(int16_t * vector, uint32_t longitud, uint32_t samples, uint32_t eco_start);

void asm_eco_simd(int16_t * vector, uint32_t longitud, uint32_t samples, uint32_t eco_start);
